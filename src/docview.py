...
class DocChildFrame(wx.Frame):
    ...
    def __init__(self, doc, view, frame, id, title, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_FRAME_STYLE, name="frame"):
        ...
        self.Bind(wx.EVT_MENU, self.ProcessEvent2, id=wx.ID_CLOSE_ALL)
        self.Bind(wx.EVT_MENU, self.ProcessEvent2, id=wx.ID_CLOSE)
        self.Bind(wx.EVT_MENU, self.ProcessEvent2, id=wx.ID_REVERT)
        ...
        self.Bind(wx.EVT_MENU, self.ProcessEvent2, id=wx.ID_PRINT)
        self.Bind(wx.EVT_MENU, self.ProcessEvent2, id=wx.ID_PRINT_SETUP)
        self.Bind(wx.EVT_MENU, self.ProcessEvent2, id=wx.ID_PREVIEW)
